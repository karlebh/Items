      ...
      <div className="w-full flex flex-col text-gray-200">
        <div className={`p-4 w-full ${modal ? "lg:w-8/12" : "lg:w-full"}`}>
          <div className="flex justify-between items-baseline mb-2">
            <h1 className="lg:text-3xl font-medium italic">
              Your Shopping Cart
            </h1>
            <button
                ...
                <div key={id}>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="flex justify-between items-center mt-6">
                        <div className="flex items-center">
                          ...
                          <div className="inline-flex flex-col items-between">
                            <button
                              className="bg-gray-600 rounded-full p-1 text-center mb-2 text-gray-50 font-semibold"
                              onClick={() => qtyPlus(item)}
                            >
                              <svg
                            ...
                            <button
                              className="bg-gray-600 rounded-full p-1 text-center mt-2 text-gray-50 font-semibold"
                              onClick={() => qtyMinus(item)}
                            >
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
                                fill="none"
                        ...
                        <div className="mr-5">${item.price}</div>
                      </div>
                      <button
                        onClick={() => remove(item)}
                      ...
                      <button
                        onClick={() => remove(item)}
                        className="absolute right-0 bg-slate-500 top-0 p-1 lg:hidden rounded-l-md"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          fill="none"
                  ...
                  {/* mobile cart above */}
                  <div
                    className="hidden mt-10 lg:grid gap-4 grid-cols-2 lg:grid-cols-6 items-center justify-items-center my-4 py-3 bg-stone-800 px-2 relative rounded-md  overflow-hidden"
                    key={id}
                  >
                    <div className="grid w-full col-span-2 lg:col-span-1 justify-items-center lg:mx-10">
                      <img
                        src={item.image}
            ...
            <div>
              <Link to="/">
                <svg
                  ...
                  strokeWidth={1.5}
                  stroke="currentColor"
                  className="w-6 h-6 inline mr-3 text-gray-200"
                >
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
        ...
        <div
          id="checkout"
          className="bg-stone-800 shadow-xl text-gray-100 p-4 lg:hidden rounded-md"
        >
          <div className="mt-32">
        ...
        {modal && (
          <div
            className="w-4/12 bg-stone-800 fixed right-0 top-0 h-screen shadow-xl text-gray-100 p-4 hidden lg:block transition-all duration-750 ease-out"
            id="modal"
          >
            <button
